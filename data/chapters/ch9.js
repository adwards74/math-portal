...
window.CHAPTER_DATA["ch9"] = {
    ...
    "ch9-4": {
        ...
        subtitle: "Simplifying & Factoring",
        content: `
            <div class="lesson-section">
                ...
                <div class="glass-card" style="padding: 20px; border-left: 4px solid var(--accent-orange);">
                    ...
                    <p style="margin-top:10px;">The $(x-2)$ factors cancel out, leaving the line $y = x+3$. However, the original function is still undefined at $x=2$. This is a "Point Discontinuity".</p>
                </div>
            </div>
        `
    },
