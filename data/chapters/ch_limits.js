...
window.CHAPTER_DATA["ch_limits"] = {
    ...
    "ch_limits-2": {
        ...
        content: `
            ...
            <div class="glass-card" style="border: 2px solid var(--accent-magenta); background: rgba(245, 87, 108, 0.05);">
                <h4 style="color: var(--accent-magenta);"><i class="fas fa-chart-line"></i> The Difference Quotient</h4>
                <p>$$ m_{tan} = \lim_{h \to 0} \frac{f(x+h) - f(x)}{h} $$</p>
                <button class="glass tutor-btn" onclick="window.plotSolution('y=x^2; y-1=2(x-1); (1,1)')" style="margin-top:15px; border-color:var(--accent-magenta);">
